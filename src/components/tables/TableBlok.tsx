const TableBlok = () => {
  return (
    <div className="flex flex-col">
      <div className="grid grid-cols-[repeat(2,10%)_repeat(5,_1fr)] grid-rows-[20%_repeat(2,minmax(80px,_1fr))] gap-1 [&>*]:rounded-md">
        <div className="grid_top_row bg-table-grey-dark col-span-2">
          obdobje
        </div>
        ...
        <div className="grid_top_row bg-table-green">blok 5</div>
      ...
      <div className="mt-6 grid grid-cols-[repeat(2,10%)_repeat(5,1fr)] grid-rows-[repeat(2,minmax(80px,_1fr))] gap-1 [&>*]:rounded-md">
        <div className="grid_h_item row-span-2 text-3xl font-bold">
          Nižja sezona
        </div>
        <div className="grid_h_item">Delovni dan</div>
